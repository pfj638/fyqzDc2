...
function nameCheck(value){
	var rootPath = $("#rootPath").val();
	var data ="userForm.loginName="+value;
	var flag = false;
	$.ajax({
        url: rootPath+"/user_ajaxLoginNameCheck.action",//请求地址
        type: "POST",//请求方式 ,get/post
        data: data,
        async: false,//同步/异步
        dataType: "json",//请求回来的数据格式
...
function addUser(){
    ...
    console.debug(data);
    $.ajax({
        url: rootPath+"/user_ajaxAdd.action",//请求地址
        type: "POST",//请求方式 ,get/post
        data: data,
        async: true,//同步/异步
        dataType: "json",//请求回来的数据格式
