...
var nicEditorConfig = bkClass.extend({
	buttons : {
		...
		'ol' : {name : __('项目编号'), command : 'insertorderedlist', tags : ['OL']},
		...
		'removeformat' : {name : __('取消格式'), command : 'removeformat', noActive : true},
		'indent' : {name : __('文本缩进'), command : 'indent', noActive : true},
		'outdent' : {name : __('取消文本缩进'), command : 'outdent', noActive : true},
...
var nicSelectOptions = {
	buttons : {
		'fontSize' : {name : __('字号'), type : 'nicEditorFontSizeSelect', command : 'fontsize'},
