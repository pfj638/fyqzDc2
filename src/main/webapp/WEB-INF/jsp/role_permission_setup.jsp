<!--
  @大成管理系统
  @file role_permission_setup.jsp
  @author: 夏选瑜
  @date: 2014-8-21
  @内容说明　大成角色的权限设置页
-->
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script type="text/javascript" src="<%=path%>/js/dc/role_permission_setup.js?v=1.1"></script>
...
<input type="hidden" id="rootPath" value="<%=path%>" />
	...
	<div class="dc_discontent">
	    <div class="dc_curt_1">
	        <div class="dc_curt_2">当前页面：权限设置</div>
	    </div>
	    <span class="tab_em_title">
	    	权限设置
	    </span>
		<table class="tab_em" id="permissionList_id" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF">
	        ...
	        <tr>
	            <td><input type="checkbox" name="userRole"/></td>
	            <td>系统管理员</td>
	            <td>维护系统安全</td>
	        </tr>
	        <tr>
	    ...
	    <div align="center"><input type="button" id="setupPermission_id" value="保存"/></div>
	    <input type="hidden" id="rolePermissionInfo" value="${requestScope.role.permission }"/>
	</div>
	</div>
<!---------底部------------->
