...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <script type="text/javascript" src="<%=path%>/js/dc/permission_new.js?v=1.1"></script>
    <style type="text/css">
        .invalid {
            color: #ea0000;
        }
	...
	<div class="content">
		...
		<table class="tab_1" width="48%"  cellpadding="0" cellspacing="0"  align="center">
		  <tr>
		    ...
		    <td width="85%">
		      <input class="text width_1 title_validate required" type="text" name="permissionForm.name" id="textfield" />
		   </td>
		  </tr>
		  <tr>
		    <td class="first_td">描述：</td>
		    <td>
		    <textarea class="required" style="width:387px;" rows="" cols="" name="permissionForm.permissionDesc" style="resize:none;"></textarea>
		    </td>
		  </tr>
		</table>
		</div>
		</form>
		<input class="submit_btn btn" type="button" id="addPermission" value="保 存"/>
		</div>
	</div>
	<!---------底部------------->
