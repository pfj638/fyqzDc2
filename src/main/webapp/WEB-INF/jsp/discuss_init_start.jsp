...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=path%>/js/dc/discuss_init_start.js"></script>
  ...
  <%@include file="/common/header.jsp"%>
    <div class="content" style="boder-left:border:1px solid red">
    <form id="discussForm" method="post" action="<%=path%>/bms/discuss_discussStartList.action"   enctype="multipart/form-data">
    ...
    <form id="pageInfo_id" method="post" action="<%=path%>/bms/discuss_discussStartList.action"   enctype="multipart/form-data">
	     <input type="hidden" name="discussManagerForm.type" value="${discussManagerForm.type}" />
	  <div class="dc_discontent">
	    <div class="dc_curt_1">
	        <div class="dc_curt_2">当前页面：启动研讨</div>
	    </div>
	      ...
	      <td>操作</td>
		    ...
		    <c:forEach var="list" items="${list}" >
		      <tr>
				      ...
				      <td>${list.status}</td>
				      <td>
				      <input class="btn_sq" type="button" value="启动"  onclick="initDiscussStart('${list.id}');" />
